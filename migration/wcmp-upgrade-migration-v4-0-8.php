...
if (class_exists('WCMP_Upgrade_Migration_v4_0_8')) {
    return new WCMP_Upgrade_Migration_v4_0_8();
}

/**
 * Migrates pre v4.0.8 settings
 */
class WCMP_Upgrade_Migration_v4_0_8 extends WCMP_Upgrade_Migration
{
    /**
     * @var array
     */
