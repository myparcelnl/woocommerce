...
/**
 * @member {Object} wc_enhanced_select_params
 */

jQuery(function($) {

  console.log(wc_enhanced_select_params);
  /**
   *
   */
  ...
  $(document.body)
    ...
    .on('wc-myparcel-enhanced-select-init', function() {
      ...
      $(':input.wc-myparcel-shipping-method-search').filter(':not(.enhanced)')
        .each(function() {
          let select2_args = {
          ...
          if ($(this).data('multiple') === true) {
            ...
            select2_args.initSelection = function(element, callback) {
              const data = $.parseJSON(element.attr('data-selected'));
              const selected = [];
