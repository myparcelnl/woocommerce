...
class WCMYPA_Admin
{
    ...
    public function showOrderActions($order): void
    {
        ...
        $processed_shipments = WCMYPA_Admin::get_order_shipments($order);
    ...
    {
        $shipments = WCMYPA_Admin::get_order_shipments($order, true);
        ...
        foreach ($shipments as $shipment_id => $shipment) {
            if (empty($shipment["track_trace"])) {
                ...
                printf(
                    ...
                    WCMYPA_Admin::getTrackTraceUrl($order, $shipment["track_trace"]),
    ...
    public static function renderTrackTraceLink(array $shipment, int $order_id): void
    {
        ...
        if ($track_trace) {
            $track_trace_url  = WCMYPA_Admin::getTrackTraceUrl($order_id, $track_trace);
