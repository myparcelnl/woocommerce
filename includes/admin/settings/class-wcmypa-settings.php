...
class WCMYPA_Settings
{
    ...
    public const SETTING_CARRIER_DEFAULT_EXPORT_SAME_DAY_DELIVERY_CUTOFF_TIME = 'export_same_day_delivery_cutoff_time';
    public const SETTING_CARRIER_DEFAULT_EXPORT_SAME_DAY_DELIVERY_FEE         = 'export_same_day_delivery_fee';
