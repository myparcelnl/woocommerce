...
class WooCommerce_PostNL_Settings {
	...
	public function general_settings() {
        ...
        add_settings_field(
			'barcode_in_note',
			__( 'Barcode in note', 'woocommerce-postnl' ),
			array( $this->callbacks, 'checkbox' ),
			$option_group,
			'general',
			array(
				...
				'description'	=> __( 'Place the track&trace code inside a note, of the order', 'woocommerce-postnl' )
            )
		);

		add_settings_field(
			'barcode_in_note_titel',
			__( 'Barcode in note titel', 'woocommerce-postnl' ),
			array( $this->callbacks, 'text_input' ),
			$option_group,
			'general',
			array(
				...
				'description'	=> __( 'You can change the text before the track&trace code inside an note', 'woocommerce-postnl' ),
			)
		);
