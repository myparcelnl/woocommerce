...
class ShippingZone extends WC_Legacy_Shipping_Zone
{
    /**
     * Zone ID
     *
    ...
    public function __construct( $zone = null ) {
        ...
        // TODO: Custom zone read function
        global $wpdb;
        ...
        if ( 0 === $zone->get_id() || '0' === $zone->get_id() ) {
             ...
             *
             * @param self $zone The shipping zone that has been loaded.
             */
     ...
     *
     * @param self $zone Shipping zone object.
     */
