...
<a href="#" class="wcpostnl_change_order">
    <table class="wcpostnl_settings_table" style="width: auto" onclick="return false;">
        <tr>
            <td>
    ...
    <br>
    <table class="wcpostnl_settings_table parcel_options">e class="wcpostnl_settings_table" style="width: auto" onclick="return false;">
        <tr>
            <td>
                <?php _e( 'Shipment type', 'woocommerce-postnl' ) ?>:<br/>
                <?php $parcel_weight = WooCommerce_PostNL()->export->get_parcel_weight( $order ); ?>
