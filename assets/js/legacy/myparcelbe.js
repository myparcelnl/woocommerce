MyParcelBE = {
  ...
  getPriceHtml: function(priceOfDeliveryOption) {
    ...
    if (parseFloat(priceOfDeliveryOption) < 0) {
      price = "<p class='colorGreen'>" + '- &euro; ' + Number(priceOfDeliveryOption).toFixed(2).replace(/-|\./g, function(match) {
        return (match == ".") ? "," : ""
      }) + "</p>";
    }
