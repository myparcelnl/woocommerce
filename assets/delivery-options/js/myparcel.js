...
(function() {
  ...
  renderDays = function(deliveryDays) {
    var $el, date, delivery, deliveryTimes, html, i, index, len;
  ...
  updateDelivery = function(e) {
    var date, deliveryTimes, html, hvoPrice, i, index, json, len, price, time;
