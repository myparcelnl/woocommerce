        ...
        public function frontend_scripts_styles() {
            ...
            if (isset(WooCommerce_MyParcel()->checkout_settings['use_split_address_fields'])) {
                wp_enqueue_script(
                    ...
                    WooCommerce_MyParcel()->plugin_url() . '/includes_php56/assets/js/wcmp-checkout-fields.js',
            ...
            wp_enqueue_script(
                'wc-myparcel',
                WooCommerce_MyParcel()->plugin_url() . '/includes_php56/assets/js/myparcel.js',
                array('jquery'),
                WC_MYPARCEL_BE_VERSION
            );
            ...
            wp_enqueue_script(
                ...
                WooCommerce_MyParcel()->plugin_url() . '/includes_php56/assets/js/wcmp-frontend.js',
                array('wc-myparcel'),
                WC_MYPARCEL_BE_VERSION
            );
        ...
        public function backend_scripts_styles() {
            ...
            if ($post_type == 'shop_order' || (is_object($screen) && strpos($screen->id, 'myparcel') !== false)) {
                ...
                if (version_compare(WOOCOMMERCE_VERSION, '2.1', '<=')) {
                    wp_enqueue_style(
                        'wcmp-admin-styles-legacy', WooCommerce_MyParcel()->plugin_url() . '/includes_php56/assets/css/wcmp-admin-styles-legacy.css', array(), WC_MYPARCEL_BE_VERSION, 'all'
                    );
                }
            }
        }
